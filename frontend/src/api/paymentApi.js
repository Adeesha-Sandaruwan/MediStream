...
/**
 * Get admin wallet summary (balance and account details)
 */
export const getAdminWalletSummary = async (token) => {
  try {
    const response = await axios.get(`${API_BASE_URL}/wallet/admin/summary`, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
 ...
 */
export const getDoctorWalletSummary = async (token, doctorId) => {
  try {
    const response = await axios.get(`${API_BASE_URL}/wallet/doctor/${doctorId}/summary`, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
    ...
    console.error('Error fetching doctor wallet summary:', error);
    throw error;
  }
};
 ...
 */
export const requestWithdrawal = async (token, walletId, withdrawalData) => {
  try {
    const response = await axios.post(`${API_BASE_URL}/wallet/${walletId}/withdraw`, withdrawalData, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
 ...
 */
export const getPendingWithdrawals = async (token) => {
  try {
    const response = await axios.get(`${API_BASE_URL}/wallet/withdrawals/pending`, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
 ...
 */
export const approveWithdrawal = async (token, withdrawalId) => {
  try {
    const response = await axios.post(`${API_BASE_URL}/wallet/withdrawals/${withdrawalId}/approve`, {}, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
